      ...
      <div class="focus-grid">
        <article class="focus-card">
          <div class="focus-card-top">
            ...
            <img src="/images/focus-01.jpg" alt="AI大厂永久基座" class="focus-img" />
          </div>
          <h3>大厂永久基座</h3>
        ...
        <article class="focus-card">
          <div class="focus-card-top">
            ...
            <img src="/images/focus-02.jpg" alt="突发大额算力" class="focus-img" />
          </div>
          <h3>突发大额羊毛</h3>
        ...
        <article class="focus-card">
          <div class="focus-card-top">
            ...
            <img src="/images/focus-03.jpg" alt="极速推理芯片" class="focus-img" />
          </div>
          <h3>极速芯片推理</h3>
        ...
        <article class="focus-card">
          <div class="focus-card-top">
            ...
            <img src="/images/focus-04.jpg" alt="开源代码工具箱" class="focus-img" />
          </div>
          <h3>开源即用工具</h3>
