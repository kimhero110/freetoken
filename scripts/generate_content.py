  ...
  <footer class="site-footer">
    <div class="container">
      ...
      <div class="footer-ecosystem">
        <span>生态基础设施：</span>
        <a href="https://github.com/withastro/astro" target="_blank" rel="noopener">Astro 极速引擎 ↗</a>
        <a href="https://github.com/BerriAI/litellm" target="_blank" rel="noopener">LiteLLM 接口网关 ↗</a>
        <a href="https://github.com/openai/openai-python" target="_blank" rel="noopener">OpenAI Python SDK ↗</a>
        <a href="https://github.com/langgenius/dify" target="_blank" rel="noopener">Dify 应用编排 ↗</a>
      </div>
      ...
      <div class="guide-grid">
        ...
        <article class="guide-card">
          <div class="guide-card-head">
            ...
            <h3>常用开源 AI 工具与客户端接入</h3>
          </div>
          <ul class="guide-tool-list">
            <li>
              <strong>终端与编程自动化</strong>：
              <a href="https://github.com/OpenCode-AI/opencode" target="_blank" rel="noopener" class="guide-repo-link">OpenCode ↗</a>、
              <a href="https://github.com/cline/cline" target="_blank" rel="noopener" class="guide-repo-link">Cline ↗</a> 或 Cursor，在设置中配置自定义 <code>Base URL</code> 与密钥即可零成本驱动代码生成。
            </li>
            <li>
              <strong>多模型对话客户端</strong>：
              <a href="https://github.com/CherryHQ/cherry-studio" target="_blank" rel="noopener" class="guide-repo-link">Cherry Studio ↗</a>、
              <a href="https://github.com/Bin-Huang/chatbox" target="_blank" rel="noopener" class="guide-repo-link">Chatbox ↗</a> 或 
              <a href="https://github.com/ChatGPTNextWeb/ChatGPT-Next-Web" target="_blank" rel="noopener" class="guide-repo-link">NextChat ↗</a>，支持多模型同屏对比与多平台免费 Key 轮询。
            </li>
            <li>
              <strong>网关聚合与负载均衡</strong>：
              推荐使用 <a href="https://github.com/songquanpeng/one-api" target="_blank" rel="noopener" class="guide-repo-link">One API ↗</a> 或 
              <a href="https://github.com/Calcium-Affliction/new-api" target="_blank" rel="noopener" class="guide-repo-link">New API ↗</a> 将全网 29 家免费 Key 统一挂载为一个聚合分发接口，自动高可用轮询。
            </li>
          </ul>
        </article>
      ...
      <div class="focus-grid">
        <article class="focus-card">
          ...
          <div class="focus-card-meta">
            ...
            <div class="focus-anchor-link">
              <a href="https://github.com/lm-sys/FastChat" target="_blank" rel="noopener">LMSYS Chatbot Arena 基准 ↗</a>
            </div>
          </div>
        </article>
        ...
        <article class="focus-card">
          ...
          <div class="focus-card-meta">
            ...
            <div class="focus-anchor-link">
              <a href="https://github.com/vllm-project/vllm" target="_blank" rel="noopener">vLLM 高并发推理引擎 ↗</a>
            </div>
          </div>
        </article>
        ...
        <article class="focus-card">
          ...
          <div class="focus-card-meta">
            ...
            <div class="focus-anchor-link">
              <a href="https://github.com/langgenius/dify" target="_blank" rel="noopener">Dify 开源应用编排 ↗</a>
            </div>
          </div>
        </article>
        ...
        <article class="focus-card">
          ...
          <div class="focus-card-meta">
            ...
            <div class="focus-anchor-link">
              <a href="https://huggingface.co/spaces/open-llm-leaderboard/open_llm_leaderboard" target="_blank" rel="noopener">Open LLM 开放榜单 ↗</a>
            </div>
          </div>
        </article>
      </div>
